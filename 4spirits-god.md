...
「神様の残りHPと経過ターン数(2人とも画面に表示してる予定)」と「神さまがAローテとBローテ現在どちらに居るか」を気にしながら見ると面白いかもねっつ。
...
プラチナキング職をマスターすると**状態異常及び属性攻撃に対する完全耐性**を得る。パーティに対する行動を全て身代わりする「仁王立ち」を習得しているメルビンにプラチナキング職をマスターさせることで、**完全耐性持ちの仁王立ち役**を作れる。このメルビンの仁王立ちで完全にシャットアウトできるのは、ステテコダンス・一発ギャグ・かまいたち・**ジゴスパーク**・**煉獄火炎**。

なお、プラチナキング職のマスターには350戦掛かる。時間にして2時間程度。

### 打撃(A・B)

守備力を762以上まで上げれば打撃ダメージをシャットアウト(最大1ダメ化)できる。メルビンの装備を固めて守備力610以上を確保した上でスクルトを1回掛けてこれを実現する。しかしスクルトを掛けなければ30~40ダメ程度喰らうので、一応、凍てつく冷気+スクルトなし打撃2回でメルビンが落ちるというパターンがある。

### 凍てつく波動(A)

メルビンが仁王立ちで身代わりしてくれるので、メルビン以外の補助呪文(スクルト・主人公へのバイキルト)は剥がされない。そのため波動誘発(味方への補助呪文によるデレ行動の凍てつく波動の誘発)は途切れない。
...
制限行動なので基本的に1ターンに2回以上来ないが、実際の死亡パターンとしては「**凍てつく冷気→ガボでベホマラーをするも神さまに後攻→再び凍てつく冷気**」や「**神さまが凍てつく冷気→Bへ→(何か)→Aへ→凍てつく冷気、という行動をとる(まれ)**」がある。

仁王立ちを貫通してパーティ全体にダメージを与えてくるため、ガボのベホマラーで回復してやる必要がある。

### 妖しい瞳(A)

問題行動その2。完全耐性持ちのメルビンは当然眠り状態をも無効にするが、妖しい瞳は**耐性を貫通**して眠らせてくる(は？)。凍てつく冷気は2回でメルビンの仁王立ちを解除するが、妖しい瞳はたった1回で解除してしまう。プラチナキング稼ぎ中メルビン以外の全員にキアリクを習得させているのは、この妖しい瞳による眠り状態を即座に回復するため。

妖しい瞳は耐性だけではなく仁王立ちも貫通するが、その点は逆にありがたい。毎回メルビンが強制睡眠喰らうとかクソゲーすぎるので。

補助・回復役のガボが眠らされたり、「誰かが妖しい瞳で眠る→別人がキアリク→神さまが先攻してキアリク役に妖しい瞳」というパターンもうざい。5人目の戦士サムシンを召喚するのは、この妖しい瞳のターゲットをばらけさせる目的も兼ねている。

### 総評

以上のように、メルビンのスクルト仁王立ち体制を崩す行動はAローテに集中している。Bローテには火力の高い攻撃が多いが、Bローテの行動は全て体制が整っていればほぼ完全にシャットアウトできるものだ。RTAにおける神さまのデレ行動は「**Bローテに居座り続けること**」であり、ツン行動は「**Aローテに居座ってこちらの体制を崩す行動をし続けること**」や「**Aローテでこちらの体制を崩した直後にBローテへ移行しジゴスパークや煉獄火炎を吐くこと**」である。
...
1T目の召喚でサムシン(確率1/3)を引けなかった場合、ガボが時の砂を使ってやり直し。サムシンは召喚使用者のLvが35以上のときに引ける精霊で、「ルカナン・魔神斬り・ドラゴン斬り・ゾンビ斬り・稲妻斬り・火炎斬り」をほぼ当確率で使用、確定2回行動。与ダメージの期待値は~~1ターンあたり約80。19ターンで約1500←サムシンの確定2回行動を忘れてるバカ~~1ターンあたり約160。19ターンで約3000。

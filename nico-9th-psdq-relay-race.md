...
- [4年前に12:58:42を出したときの自分の戦略](http://pingval.g1.xrea.com/dq7/rta-12h58m42s/)は、自分にとって馴染み深いし一発勝負に向いた安定戦略なので、**この戦略から大きくは変えない**。
- 安定性を損ねない短縮要素はありがたく取り入れさせていただくが、大きく損ねそうなものや大きなチャート変更を要するものは取り入れない。
  - 前者: 過去ルーメンベビーゴイルはなす技など
  - 後者: 疾風のバンダナカットなど
  - ダーマ6連戦「主マガ」→「主ガマ」は悩む。
- 戦力が不足しているためちょっとしたミスが死亡や全滅に繋がりやすい序盤、特に**炎の巨人撃破まで**は安全走行を心がける。
- 練習大事なボス戦
  - デスマシーン
  - あめふらし
  - 洞窟魔人
...
- 過去エンゴウで祭り前に命の木の実を回収＆使用
- 「全員おれまか→主:防御からのラリホー逃げ」の利用
  - AI変更に注意。
- 洞窟魔神戦マリベルAI命大事に
  - 後出しホイミありがたい。
- 不思議な木の実のガボへの投与を遅らせる
  - 洞窟魔人戦の1T目、しっぺ返し中のマリベルに踊る宝石の不思議な踊りが刺さる(そして踊る宝石のMPを2減らしルカナンを封じる)確率を上げるため。
  - 踊る宝石は賢さ2なので、MP0のキャラは不思議な踊りの対象から外れる。不思議の木の実未投与のガボはMP0。
  - ……なんか計算したら、踊る宝石のルカナンを封じれる確率は約4.8%から約7.2%に上がるだけらしいけど。まあいいや。
- ネリス戦のスカラカウントをカウントダウン形式に
  - 主人公とザジでスカラの持続回数が異なると知ったので共通して使えるやり方を。
  - 主人公のは6T、ザジのは5T持続する。
- 世界一高い塔壁抜け
- 過去ルーメンのベビーゴイル戦はなす技
  - 素早さがクソ高いベビーゴイルに確定先攻ステテコダンス。
  - そのために隊列を「メ＞主＞マ＞ガ」から「メ＞主＞ガ＞マ」へ変更している。かなり違和感。
- メルビン体当たり習得
  - アイラ加入後の熟練度稼ぎを[るるmk2さんのチャート](https://ch.nicovideo.jp/rurumk2/blomaga/ar798180)と同じにする。
  - ダーマ神殿の出入りが1回増える(15sロス)代わりに体当たりを習得。過去レブレサックのフォレストガード戦と過去サンゴの洞窟の自殺ルーラで使う。
- 炎の精霊戦主人公を後ろへ下げる
  - 「ア＞主＞ガ＞マ」から「ア＞ガ＞主＞マ」へ。
  - 主人公が死ぬとマーレ会話イベントが進められないしガボの方が炎耐性高い。
- オルゴ2戦メルビン3列目
  - 「ア＞メ＞主＞ガ」から「ア＞主＞メ＞ガ」へ。
  - 2-2でメルビンが漣の剣を使うときとか安心らしいので。
- オルゴ2-1のとどめではなす技
  - はなす技によって、アイラの高火力なバイキルト気合ため火炎斬りを確定先攻で入れられる。
  - ついでにメルビンの打撃も入る。
- オルゴ2-2「かまいたち+イオナズン」ターンでメルビン魔法の法衣換装
  - 魔法の法衣(バギ耐性25)を装備することにより、メルビンへのかまいたち最大乱数が127から109に下がる。
  - これを利用すれば、オルゴ2-1のとどめで「アイラの疾風のバンダナ換装後火炎斬り + ガボの祝福の杖」という選択を取る必要なくなる。
  - 従来換金していた魔法の法衣(売値2000G)を温存するので、代わりに海賊船の海賊の服(売値2100G)を回収し換金する。
...
- 世界一高い塔壁抜け
  - 落下判定が手前にしかないから左に行き過ぎても無問題だった。よゆー
- 過去ルーメンのベビーゴイル戦はなす技
  - 「メ主マガ」→「メ主ガマ」にする必要がある。「メ主マガ」で後攻ラリホーは？　手間が掛かるか。
    - マリベルを最後尾にすることによって、メルビン加入直後の満タンでマリベルのMPが消費されるのはまずい。どうしよ？　メルビンのMPで手動回復するか？
  - 2T目以降は別にいいだろう。ラリホー回避確定が1T目だけになるけど。
- メルビン体当たり習得
  - 1回やってみるか？
  - 「魔神斬り」「ベホマラー」「剣の舞」すべての習得を確認することに注意。
...
- オルゴ2-1はなす技
  - 2-1とどめターン祝杖用のアイラ疾バは不要か？
    - [不要だろう](https://github.com/pingval/DQ7/blob/master/psdq7_orgo2-1talk.rb)
      - 人魚の月は、アイテム欄の一番下【→】ではなく、装備の真下【侭】に変えよう。
